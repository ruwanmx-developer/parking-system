                ...
                if (x.code === "c1") {
                    if (x.price > 0) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Time Exceeded',
                            html: "You have use the time more than you booked in the system. You have to pay <b>Rs." +
                                x.price +
                                ".00</b> to finish the payment.",
                            showCancelButton: true,
                            cancelButtonText: 'Unpaid, Cancel!',
                            confirmButtonText: 'Paid to the counter, Confirm!',
                            reverseButtons: true
                        }).then((result) => {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (x.code === "c1") {
                    ...
                    Swal.fire({
                        ...
                        html: "You can take your vehical out from your slot now."
                    }).then(() => {
