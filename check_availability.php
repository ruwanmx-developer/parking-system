    ...
    function book_slot(state, floor, slot) {
        ...
        if (state == 2) {
            ...
            Swal.fire({
                ...
                text: "Do you want to book this parking slot for your vehical",
                ...
                if (result.isConfirmed) {
                    if (user) {
                        ...
                        Swal.fire({
                            ...
                            text: "You have to log in to your account before booking a slot. Do you want to go the login page",
                            showCancelButton: true,
                            cancelButtonText: 'No, cancel!',
            ...
            Swal.fire({
                icon: 'info',
                title: 'Slot Unavailable',
                text: "This slot is booked by you. If you want to book another slot you have choose another location.",
            })
        }
    }
    view_floor(1);
