    ...
    function payment() {
        ...
        if (floor === "") {
            Swal.fire({
                icon: 'warning',
                title: 'Invalid Data',
                text: 'Some data has been corrupted. Please Try Again!'
            }).then(() => {
                window.location = "./check_availability.php";
            })
            return;
        }
        if (slot === "") {
        ...
        if (vehicalNo === "") {
            Swal.fire({
                icon: 'warning',
                title: 'Empty Field',
                text: 'Please enter the vehical plate no to continue'
            })
            return;
        }
        if (!(v_no_pattern.test(vehicalNo))) {
            Swal.fire({
                ...
                title: 'Invalid field',
                html: "<b>" + vehicalNo +
                    "</b> is not an valid vehical plate no. Enter a valid vehical plate no"
            })
            return;
        }
        if (date === "") {
            Swal.fire({
                icon: 'warning',
                title: 'Empty Field',
                text: 'Please select the date to continue'
            })
            return;
        }
        if (time === "") {
            Swal.fire({
                icon: 'warning',
                title: 'Empty Field',
                text: 'Please select the time to continue'
            })
            return;
        }
